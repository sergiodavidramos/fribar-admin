...
const editarCosto = () => {
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (!costo && router && router.query.id) {
        const { id } = router.query
        fetch(`${API_URL}/costo-envio/${id}`, {
          method: 'GET',
          headers: {
  ...
  const handlerEditarCosto = () => {
    ...
    if (!target[0].value || !target[1].value || !target[2].value)
      ...
      fetch(`${API_URL}/costo-envio/${costo._id}`, {
        method: 'PATCH',
        body: JSON.stringify({
        ...
        .then((res) => {
          ...
          else notify.show('costo editado con Exito! ', 'success', 2000)
        })
        .catch((error) => {
          console.log(error)
                  ...
                  <div className="col-lg-5 col-md-6">
                    <div className="card card-static-2 mb-30">
                      ...
                      <div className="card-body-table">
                        <form onSubmit={handlerEditarCosto}>
                          <div className="news-content-right pd-20">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                required
                                defaultValue={costo.costoNormal}
                              />
                            </div>
                            <div className="form-group">
                              <label className="form-label">
                              ...
                              <input
                                ...
                                required
                                defaultValue={costo.cantidadTotalPromo}
                              />
                            </div>
                            <div className="form-group">
                              <label className="form-label">
